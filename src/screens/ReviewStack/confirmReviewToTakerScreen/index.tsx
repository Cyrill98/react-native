...
const ConfirmReviewToTakerScreen = () => {
    const user = '@lsyakiru'
        ...
        <View style={styles.root}>
            ...
            <View style={styles.detailContainer}>
                ...
                <View style={styles.noteContainer}>
                    ...
                    <Text style={[typography.body, {textAlign: 'center'}]}>Thank you for your review! Your review has been published and can be seen only by the taker. You will have 7 days to resolve any conflict with the taker and edit any review you have. After the 7-day period, all reviews will be published publicly, and no editing will be allowed.</Text>
...
export default ConfirmReviewToTakerScreen
